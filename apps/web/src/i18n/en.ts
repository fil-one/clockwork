export const en = {
  ...
  "app.assisted": "Assisted mode",
  "app.assisted.description":
    "You are acting for {account}. Your identity, reason, and every action are recorded.",
  "app.assisted.exit": "Exit assisted mode",
  ...
  "nav.partner.more": "Partner controls",
  ...
  "nav.internal.admin": "Administration",
