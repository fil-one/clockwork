...
> = {
  "61000000-0000-4000-8000-000000000003": {
    name: demoText({
      ...
      ja: "架空の期間なしストレージ",
      pt: "Armazenamento fictício sem prazo",
      zh: "虚构的无期限存储",
    ...
    serviceNotice: demoText({
      ...
      de: "Nur eine fiktive Demo. Ihre Anfrage aktiviert keinen Mandanten beim Anbieter und startet keine Abrechnung. Vor Beginn des Dienstes ist eine verifizierte Übergabe erforderlich.",
    ...
    trialNotice: demoText({
      ...
      pt: "Apenas uma demonstração fictícia. A elegibilidade para o período de teste é verificada uma única vez por organização e domínio. Nenhuma conversão para pago ocorre sem sua solicitação separada.",
