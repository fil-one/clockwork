...
const fixtures: readonly CommercialFixture[] = [
  {
    ...
    facts: {
      ...
      description: demoText({
        ...
        de: "Vertragsvorlage von Fil One · unterzeichnet",
        ja: "Fil One の標準契約書・署名済み",
        pt: "Contrato padrão da Fil One · assinado",
        zh: "Fil One 标准合同 · 已签署",
        ar: "نموذج عقد Fil One · موقّع",
      }),
  ...
  },
  {
    ...
    facts: {
      ...
      description: demoText({
        ...
        de: "Vertragsdokument des Kunden · vier Kernklauseln in rechtlicher Prüfung",
  ...
  },
  {
    ...
    facts: {
      ...
      description: demoText({
        ...
        pt: "12 TB · aprovada nos quatro testes de sucesso",
        zh: "12 TB · 4 项成功测试全部通过",
        ar: "12 تيرابايت · اجتياز اختبارات النجاح الأربعة كلها",
      }),
