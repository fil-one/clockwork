...
const amendmentRecords: readonly CustomerCollectionFixture[] = [
  {
    ...
    description: demoText({
      ...
      zh: "接受后为合规副本增加 40 TB。",
      ar: "يضيف 40 تيرابايت إلى نسخة الامتثال بعد القبول.",
    }),
    status: "review",
  ...
  },
  {
    ...
    title: demoText({
      ...
      ja: "サポートの応答時間",
      pt: "Cronograma de resposta do suporte",
      zh: "支持响应时间表",
    ...
    description: demoText({
      ...
      pt: "Adiciona o cronograma de resposta ampliado aos dois serviços.",
      zh: "为两项服务增加增强响应时间表。",
...
const userRecords: readonly CustomerCollectionFixture[] = [
  ...
  },
  {
    ...
    description: demoText({
      ...
      de: "Abrechnungskontakt für Rechnungen, Zahlungen und Steuerunterlagen.",
  ...
  },
  {
    ...
    description: demoText({
      ...
      de: "Mitglied mit Lesezugriff auf Vereinbarungen und Dienste.",
  ...
  },
  {
    ...
    description: demoText({
      ...
      pt: "Convite enviado para os papéis de administrador da conta e aprovador jurídico.",
      zh: "已邀请担任账户管理员和法务审批人。",
...
const procurementRecords: readonly CustomerCollectionFixture[] = [
      ...
      { field: "system", value: literal("Coupa") },
      {
        ...
        value: {
          ...
          text: demoText({
            ...
            zh: "客户银行核验",
            ar: "تحقق العميل من الحساب المصرفي",
          }),
        },
      },
    ],
  ...
  },
  {
    ...
    description: demoText({
      ...
      de: "Bestellung für den EU-Compliance-Dienst angenommen.",
...
const marketplaceRecords: readonly CustomerCollectionFixture[] = [
  ...
  },
  {
    ...
    title: demoText({
      ...
      de: "Azure-Angebot · Erweiterung im Vereinigten Königreich",
  ...
  },
  {
    ...
    description: demoText({
      ...
      zh: "只读服务商数据源显示付款待处理。",
      ar: "صرف المستحقات معلّق في بيانات المزوّد المتاحة للقراءة فقط.",
    }),
    status: "review",
  ...
  },
  {
    ...
    title: demoText({
      ...
      de: "Privates AWS-Angebot · Testumgebung für Wiederherstellung",
      ja: "AWS プライベートオファー・復旧用サンドボックス",
      pt: "Oferta privada da AWS · ambiente de testes de recuperação",
      zh: "AWS 私有报价 · 恢复沙盒",
      ar: "عرض خاص من AWS · بيئة اختبار الاسترداد",
    }),
    description: demoText({
...
const supportRecords: readonly CustomerCollectionFixture[] = [
  {
    ...
    description: demoText({
      ...
      ar: "يراجع فريق الدعم أحدث أوقات استرداد العينة.",
    }),
    status: "active",
