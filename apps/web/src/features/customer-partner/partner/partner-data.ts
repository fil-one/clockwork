...
const registrations: readonly PartnerFixture[] = [
  ...
  },
  {
    ...
    context: demoText({
      ...
      de: "Empfehlung · in einen aktiven Service umgewandelt",
      ja: "紹介・稼働中のサービスに移行済み",
...
const commissions: readonly PartnerFixture[] = [
  {
    ...
    name: demoText({
      ...
      ja: "第3四半期のコミッション明細書",
      pt: "Demonstrativo de comissões do 3º trimestre",
      zh: "第三季度佣金结算单",
...
const marketplace: readonly PartnerFixture[] = [
  {
    ...
    name: demoText({
      ...
      de: "Privates Angebot von AWS für Halcyon",
    ...
    context: demoText({
      ...
      ja: "再販・Fil One の販売者登録・取引担当：Meridian",
  ...
  },
  {
    ...
    name: demoText({
      ...
      de: "Privates Angebot von Azure für Atlas",
...
const brand: readonly PartnerFixture[] = [
  {
    ...
    context: demoText({
      ...
      ja: "quotes.meridian.example・パートナーの営業窓口",
  ...
  },
  {
    ...
    context: demoText({
      ...
      de: "DNS-Verifizierung an den Domainadministrator delegiert",
...
const support: readonly PartnerFixture[] = [
  {
    ...
    name: demoText({
      ...
      de: "Dauer der Wiederherstellung einer Stichprobe für Halcyon",
      ja: "Halcyon の復元サンプルの所要時間",
      pt: "Tempo de restauração da amostra · Halcyon",
      zh: "Halcyon 恢复样本耗时",
