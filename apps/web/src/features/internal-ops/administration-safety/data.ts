...
export const approvalCases: readonly ApprovalCase[] = [
  {
    ...
    evidence: [
      ...
      demoText({
        ...
        de: "Das Kreditrisiko bleibt innerhalb des Finanzschwellenwerts",
  ...
  },
  {
    ...
    evidence: [
      demoText({
        ...
        de: "Änderungsmarkierung der Rechtsabteilung gegenüber CSA v3.2",
        ja: "CSA v3.2 に対する法務の修正履歴",
        pt: "Revisão com marcações do jurídico em relação ao CSA v3.2",
    ...
    downstreamEffect: demoText({
      ...
      pt: "A aprovação libera a contra-assinatura; a rejeição devolve a revisão ao proprietário da conta.",
  ...
  },
  {
    ...
    impact: demoText({
      ...
      de: "Autorisiert das Löschen nicht gesperrter Objekte nach Ablauf des Abruffensters.",
      ja: "取得期間の終了後に、ロックされていないオブジェクトの削除を許可します。",
      pt: "Autoriza a exclusão dos objetos não bloqueados após o encerramento do período de recuperação.",
    ...
    evidence: [
      demoText({
        ...
        de: "Abrufhinweis vom Kunden bestätigt",
        ja: "顧客が取得通知を確認済み",
        pt: "Aviso de recuperação confirmado pelo cliente",
        zh: "客户已确认取回通知",
...
const gateFixtures: readonly GateFixture[] = [
  ...
  },
  {
    ...
    capability: demoText({
      ...
      de: "Aktivierung kostenpflichtiger Dienste",
      ja: "有料サービスの有効化",
    ...
    activationTest: demoText({
      ...
      pt: "O resultado do simulador, seguro para reprocessamento, faz parte do registro de contingência",
  ...
  },
  {
    ...
    title: demoText({
      ...
      ja: "法務承認済みの法的ポリシー",
      pt: "Política jurídica aprovada pelo jurídico",
      zh: "经法务批准的法律政策",
  ...
  },
  {
    ...
    capability: demoText({
      ...
      pt: "Ofertas privadas, identidade de pedidos e reprocessamento de liquidações",
      zh: "私有报价、订单标识和结算重放",
    ...
    activationTest: demoText({
      ...
      pt: "Reprocessamento no limite do provedor não executado",
      zh: "服务商边界重放未运行",
    ...
    reason: demoText({
      ...
      pt: "Os testes de identidade do marketplace e de reprocessamento de liquidações precisam ser aprovados.",
      zh: "云市场身份和结算重放测试必须通过。",
