// i18n-exempt-file: builds generated PDF document inputs (translation policy rule 5) and API problem titles (integrator contract; the interface maps `code`, see contracts/error-text.ts).
