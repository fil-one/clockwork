  ...
  record(
    ...
    commercial({
      ...
      title: demoText({
        ...
        ja: "PoC の本契約への移行・フィールドテレメトリーのアーカイブ",
  ...
  record(
    ...
    collection({
      ...
      description: demoText({
        ...
        ja: "PoC の本契約への移行後、フィールドアーカイブに 15 TB を追加します。",
...
const internalBook: readonly DemoPortalRecord[] = [
  ...
  internal("queues", "queue-price-harborline", {
    ...
    description: demoText({
      ...
      ja: "Cobalt Orchard 向けの2階層販売の見積もりは、公表済みの下限価格を 8.4% 下回っています。",
  ...
  internal(
    ...
    "ORD-2026-0098",
    {
      title: demoText({
        ...
        ja: "Northstar のプライマリアーカイブ・Meridian",
