...
insert into accounts (
  ...
  parent_partner_id, partner_agreement_type, partner_discount_tier, commission_rate_bps, aggregate_credit_limit_minor
) values
('10000000-0000-4000-8000-000000000001','Northstar Archive Labs',array['direct_client'], '{"line1":"1 Fiction Way","city":"Boston","postalCode":"02108","country":"US"}', '{"name":"Dana Direct","email":"billing@northstar.test"}', '{"name":"Alex AP","email":"ap@northstar.test"}', 'ap@northstar.test','northstar.test','US','USD','clear',null,null,null,null,0),
('10000000-0000-4000-8000-000000000002','Redwood Channel Group',array['partner'], '{"line1":"2 Fiction Way","city":"London","postalCode":"EC1A 1AA","country":"GB"}', '{"name":"Riley Referral","email":"billing@redwood.test"}', '{"name":"Parker AP","email":"ap@redwood.test"}', 'ap@redwood.test','redwood.test','GB','GBP','clear',null,'referral','gold',1200,5000000),
('10000000-0000-4000-8000-000000000003','Blue Harbor MSP',array['partner'], '{"line1":"3 Fiction Way","city":"Madrid","postalCode":"28001","country":"ES"}', '{"name":"Morgan MSP","email":"billing@blueharbor.test"}', '{"name":"Sam AP","email":"ap@blueharbor.test"}', 'ap@blueharbor.test','blueharbor.test','ES','EUR','clear',null,'resale','silver',null,10000000),
('10000000-0000-4000-8000-000000000004','Juniper Health Demo',array['end_client'], '{"line1":"4 Fiction Way","city":"Denver","postalCode":"80202","country":"US"}', '{"name":"Jamie Client","email":"billing@juniper.test"}', '{"name":"Taylor AP","email":"ap@juniper.test"}', 'ap@juniper.test','juniper.test','US','USD','clear',null,null,null,null,0),
('10000000-0000-4000-8000-000000000005','Atlas Distribution Demo',array['partner'], '{"line1":"5 Fiction Way","city":"Chicago","postalCode":"60601","country":"US"}', '{"name":"Drew Distributor","email":"billing@atlas.test"}', '{"name":"Casey AP","email":"ap@atlas.test"}', 'ap@atlas.test','atlas.test','US','USD','clear',null,'resale','distributor',null,25000000),
('10000000-0000-4000-8000-000000000006','Cobalt Reseller Demo',array['partner'], '{"line1":"6 Fiction Way","city":"Austin","postalCode":"78701","country":"US"}', '{"name":"Avery Seller","email":"billing@cobalt.test"}', '{"name":"Finley AP","email":"ap@cobalt.test"}', 'ap@cobalt.test','cobalt.test','US','USD','clear','10000000-0000-4000-8000-000000000005','resale','two-tier',null,3000000),
('10000000-0000-4000-8000-000000000007','Ivory Embedded Demo',array['partner'], '{"line1":"7 Fiction Way","city":"Seattle","postalCode":"98101","country":"US"}', '{"name":"Robin White Label","email":"billing@ivory.test"}', '{"name":"Skyler AP","email":"ap@ivory.test"}', 'ap@ivory.test','ivory.test','US','USD','clear',null,'embedded','white-label',null,5000000),
('10000000-0000-4000-8000-000000000008','Mercury Marketplace Demo',array['partner'], '{"line1":"8 Fiction Way","city":"New York","postalCode":"10001","country":"US"}', '{"name":"Quinn Market","email":"billing@mercury.test"}', '{"name":"Emerson AP","email":"ap@mercury.test"}', 'ap@mercury.test','mercury.test','US','USD','clear',null,'resale','marketplace',null,8000000),
('10000000-0000-4000-8000-000000000009','Clockwork Internal Operations',array['direct_client'], '{"line1":"9 Fiction Way","city":"Wilmington","postalCode":"19801","country":"US"}', '{"name":"Internal Operations","email":"operations@clockwork.test"}', '{"name":"Internal Finance","email":"finance@clockwork.test"}', 'finance@clockwork.test','clockwork.test','US','USD','clear',null,null,null,null,0);
...
('40000000-0000-4000-8000-000000000019','10000000-0000-4000-8000-000000000008','quote','demo/quote-marketplace.pdf',lpad('19',64,'0'),'application/pdf',2048,'COMPLIANCE','2033-07-31T16:00:00Z','demo-v1'),
('40000000-0000-4000-8000-000000000020','10000000-0000-4000-8000-000000000008','partner_quote','demo/partner-quote-marketplace.pdf',lpad('20',64,'0'),'application/pdf',2048,'COMPLIANCE','2033-07-31T16:00:00Z','demo-v1'),
...
('40000000-0000-4000-8000-000000000025','10000000-0000-4000-8000-000000000008','order_form','demo/order-marketplace.pdf',lpad('25',64,'0'),'application/pdf',2048,'COMPLIANCE','2033-07-31T16:00:00Z','demo-v1'),
...
('70000000-0000-4000-8000-000000000003','10000000-0000-4000-8000-000000000003','10000000-0000-4000-8000-000000000004','10000000-0000-4000-8000-000000000003','60000000-0000-4000-8000-000000000002','70100000-0000-4000-8000-000000000003',1,'accepted','EUR',168000,'pass','2026-08-31T16:00:00Z','20000000-0000-4000-8000-000000000008','40000000-0000-4000-8000-000000000013','40000000-0000-4000-8000-000000000014',216000,'2026-07-21T16:00:00Z'),
('70000000-0000-4000-8000-000000000004','10000000-0000-4000-8000-000000000005','10000000-0000-4000-8000-000000000004','10000000-0000-4000-8000-000000000005','60000000-0000-4000-8000-000000000001','70100000-0000-4000-8000-000000000004',1,'accepted','USD',132000,'pass','2026-09-30T16:00:00Z','20000000-0000-4000-8000-000000000005','40000000-0000-4000-8000-000000000015','40000000-0000-4000-8000-000000000016',180000,'2026-07-22T16:00:00Z'),
('70000000-0000-4000-8000-000000000005','10000000-0000-4000-8000-000000000007','10000000-0000-4000-8000-000000000004','10000000-0000-4000-8000-000000000007','60000000-0000-4000-8000-000000000001','70100000-0000-4000-8000-000000000005',1,'accepted','USD',144000,'pass','2026-09-30T16:00:00Z','20000000-0000-4000-8000-000000000006','40000000-0000-4000-8000-000000000017','40000000-0000-4000-8000-000000000018',192000,'2026-07-23T16:00:00Z'),
('70000000-0000-4000-8000-000000000006','10000000-0000-4000-8000-000000000008','10000000-0000-4000-8000-000000000004','10000000-0000-4000-8000-000000000008','60000000-0000-4000-8000-000000000001','70100000-0000-4000-8000-000000000006',1,'accepted','USD',156000,'pass','2026-09-30T16:00:00Z','20000000-0000-4000-8000-000000000007','40000000-0000-4000-8000-000000000019','40000000-0000-4000-8000-000000000020',204000,'2026-07-24T16:00:00Z'),
...
('80000000-0000-4000-8000-000000000004','70000000-0000-4000-8000-000000000004','51000000-0000-4000-8000-000000000004','10000000-0000-4000-8000-000000000004','10000000-0000-4000-8000-000000000005','10000000-0000-4000-8000-000000000005','resale','PO-DIST-004','20000000-0000-4000-8000-000000000005','Distribution Director',true,'active','2026-08-01','2027-07-31','2027-06-01','40000000-0000-4000-8000-000000000023','2026-07-22T16:00:00Z'),
...
('80000000-0000-4000-8000-000000000006','70000000-0000-4000-8000-000000000006','51000000-0000-4000-8000-000000000006','10000000-0000-4000-8000-000000000004','10000000-0000-4000-8000-000000000008','10000000-0000-4000-8000-000000000008','resale','PO-MARKET-006','20000000-0000-4000-8000-000000000007','Marketplace Director',true,'active','2026-08-01','2027-07-31','2027-06-01','40000000-0000-4000-8000-000000000025','2026-07-24T16:00:00Z'),
...
('90000000-0000-4000-8000-000000000006','80000000-0000-4000-8000-000000000006','10000000-0000-4000-8000-000000000008','in_demo_marketplace','USD',156000,'PO-MARKET-006','open','2026-08-31T16:00:00Z'),
('90000000-0000-4000-8000-000000000007','80000000-0000-4000-8000-000000000007','10000000-0000-4000-8000-000000000004','in_demo_conversion','USD',180000,'PO-DIRECT-007','draft','2026-08-31T16:00:00Z');
...
insert into commission_accruals (id, partner_account_id, invoice_id, rate_bps, currency, net_collected_revenue_minor, amount_minor, holdback_minor, period, status) values
('93500000-0000-4000-8000-000000000001','10000000-0000-4000-8000-000000000002','90000000-0000-4000-8000-000000000002',1200,'USD',120000,14400,0,'2026-08','accrued');
